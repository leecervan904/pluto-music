<template>
  <div class="home-search" v-show="showSearch">
    <div class="home-search__history">
      <div class="history-title">历史</div>
      <base-scroll class="history-content__wrapper" ref="scroll"
        :options="historyScrollOption"
        :data="history">
        <div class="history-content">
          <span class="history-content__item"
            v-for="item in history" :key="item.score"
            @click="onSearch(item)"
    ...
    <div class="home-search__hot">
      ...
      <base-scroll class="hot-content__wrapper" ref="scroll2"
        :options="scrollOptions"
        :data="hotSearch">
        <div class="hot-content">
          <p class="hot-content__item"
