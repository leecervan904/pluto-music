  ...
  <div class="ms">
    ...
    <ul class="ms-list">
      ...
      <li v-if="searchResult.artists" class="list-item">
        <h3 class="title-left">
          <i class="title-left__icon-singer" />
          <em>歌手</em>
        </h3>
        <ul class="sub-list">
      ...
      <li v-if="searchResult.albums" class="list-item">
        <h3 class="title-left">
          <i class="title-left__icon-album" />
          <em>专辑</em>
        </h3>
        <ul class="sub-list">
      ...
      <li v-if="searchResult.mvs" class="list-item">
        <h3 class="title-left">
          <i class="title-left__icon-video" />
          <em>视频</em>
        </h3>
        <ul class="sub-list">
      ...
      <li v-if="searchResult.playlists" class="list-item">
        <h3 class="title-left">
          <a class="title-left__icon-playlist" />
          <em>歌单</em>
        </h3>
        <ul class="sub-list">
