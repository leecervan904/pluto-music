<template>
  <section class="playlist">
    <h2 class="playlist-title">
      ...
      <router-link class="playlist-title__more" to="/playlist-square"> 查看更多 </router-link>
    </h2>

    <transition name="fade">
      <ul ref="content" class="playlist-content" :style="{ height: contentHeight }">
        <PlaylistItem
...
const cateNew = {
  title: '最新',
  order: GetRelatedPlaylistParamsOrderType.NEW,
}

const activeOrder = ref<GetRelatedPlaylistParamsOrderType>(GetRelatedPlaylistParamsOrderType.HOT)
...
const handleSelect = (order: GetRelatedPlaylistParamsOrderType) => {
